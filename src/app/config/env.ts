...
export const ENVConfig = {
  ...
  CODEPUSH_KEY_IOS: Config.CODE_PUSH_DEPLOYMENT_KEY_IOS,
  CODEPUSH_KEY_ANDROID: Config.CODE_PUSH_DEPLOYMENT_KEY_ANDROID,
  LOCAL_STORAGE_SECRET_KEY: Config.LOCAL_STORAGE_SECRET_KEY,
};
