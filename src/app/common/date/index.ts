...
export function formartDateCustom(value: any, type: string, toType: string) {
...
export function calculateIntestSaving(
  ...
  // lãi suất tính đến ngày hiện tại vs 0.2%
  const amountInterestToday = Math.round(((interest / 100) * amount * day) / 365);
  return amountInterestToday;
}
